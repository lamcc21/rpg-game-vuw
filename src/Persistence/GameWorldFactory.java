...
public class GameWorldFactory {
    public static void main(String[] arg) {
        ...
        KeyComponent pen = new KeyComponent(1, 1, 1, 1, 1, 1, "Pen", "A Nice Pen", GameWorld.Direction.NORTH, GameColor.cyan);
        KeyComponent plant = new KeyComponent(5, 5, 1, 50, 50, 1, "Pot plant", "Greenery", GameWorld.Direction.NORTH, GameColor.cyan);
        KeyComponent painting = new KeyComponent(7, 10, 1, 50, 50, 1, "Painting", "its A Painting", GameWorld.Direction.NORTH, GameColor.cyan);
        KeyComponent chair = new KeyComponent(2, 15, 1, 50, 50, 1, "Chair", "its A Chair", GameWorld.Direction.NORTH, GameColor.purple);
        KeyComponent table = new KeyComponent(6, 9, 1, 50, 50, 1, "Table", "its A Table ", GameWorld.Direction.NORTH, GameColor.purple);
        KeyComponent ed = new KeyComponent(7, 10, 1, 50, 50, 1, "ed", "its A ed", GameWorld.Direction.NORTH, GameColor.purple);
        ...
        northComponents.add(chair);
        northComponents.add(table);
