	...
	private Application() throws IOException, InterruptedException {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				int PromptResult = JOptionPane.showOptionDialog(null, "Would you like to save?", "",
	...
	private void startListening() throws InterruptedException {
		while (true) {
			...
			if (gameWorld.getPlayer().craftGuiUpdateNeeded()) {
				...
				gameWorld.getPlayer().toggleUpdateNeeded(); // stopped the craft gui from updating till another item is
															// added
			}
			Thread.sleep(50);
